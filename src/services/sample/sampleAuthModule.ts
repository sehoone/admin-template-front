...
import { httpAuth } from '@/services/sample/sampleAuthApi';
import type { AuthInterface } from '@/services/sample/model/sampleAuthModel';
...
export const useSampleAuthStore = defineStore('auth-store', {
  state: (): authState => ({
