...
import type { HellowModel } from '@/services/sample/model/helloWorldModel';
import { getHellowText } from '@/services/sample/helloWorldApi';

interface HelloWorldState {
  helloText: string;
}

export const useHelloWorldStore = defineStore('app-hello-world', {
